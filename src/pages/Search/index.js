    ...
    if(city) {
        return (
            <SafeAreaView style={styles.container}>
                  <TouchableOpacity style={styles.backButton} onPress={() => nativation.navigate('Home')}>
                    <Feather 
                        name="chevron-left"
                        size={32}
                        color="#000"
             ...
             <LinearGradient style={styles.header} colors={['#1ed6ff', '#97c1ff']} >
                <Text style={styles.date}>{city.results && city.results.date }</Text>
                <Text style={styles.city}>{city.results && city.results.city_name }</Text>
                
                <View>
                    <Text style={styles.temp}>{city.results && city.results.temp } °</Text>
                </View>
